...
nutrients_4month_6diets<-stepfun(hours,c(0,0,50,0,50,0,50,0,50,0,50,0,50,0,0),right=FALSE)
pdf("nutrients_0-4month_6diets.pdf",width=8.92,height=4.1)
...
pdf("nutrients_4-12month.pdf",width=8.92,height=4.1)
...
## 12m data plot
# nutrients_12m$
data_12m<-read.table('12m_24h_data_comparison.txt',header=T, row.names=1, sep="\t", stringsAsFactors=T)
# data_4m<-data_4m[,-3]
