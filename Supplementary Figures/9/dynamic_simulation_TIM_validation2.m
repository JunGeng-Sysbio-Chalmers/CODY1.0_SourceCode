...
out_time=[];
t_open=[];V5_open=[];
[T Y]=my_runge_kutta4_TIM(@qssm_comm_TIM_validation2,y0,tspan,FSG,Feed,V); 
...
% saveas(gcf, 'test.png');
export_fig Validation2_lumen_mets.pdf -q101
...
export_fig Validation2_mucus_mets.pdf -q101
...
%     title('Feces Volume [L]','fontsize',10,'fontname','Helvetica'); 
    set(findobj(get(gca,'Children'),'LineWidth',1.5),'LineWidth',2);
      set(gca,'linewidth',1.5,'YTick',[0 0.1],'fontsize',21);
...
export_fig Validation2_feces_mets.pdf -q101
...
export_fig Validation2_Blood_mets.pdf -q101
...
export_fig Validation2_Inflow_Outflow.pdf -q101
...
export_fig Validation2_Feeding_hexose.pdf -q101
