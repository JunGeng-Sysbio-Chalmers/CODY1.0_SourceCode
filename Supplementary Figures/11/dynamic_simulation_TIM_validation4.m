...
out_time=[];
t_open=[];V5_open=[];
[T Y]=my_runge_kutta4_TIM(@qssm_comm_TIM_validation4,y0,tspan,FSG,Feed,V);  
...
% saveas(gcf, 'test.png');
export_fig Validation4_lumen_mets.pdf -q101
...
export_fig Validation4_mucus_mets.pdf -q101
...
export_fig Validation4_feces_mets.pdf -q101
...
export_fig Validation4_Blood_mets.pdf -q101
...
export_fig Validation4_Inflow_Outflow.pdf -q101
...
export_fig Validation4_Feeding_hexose.pdf -q101
