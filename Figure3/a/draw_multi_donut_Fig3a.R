...
exp_file <- "experimentdata.txt"
prd_file<-"prediction.txt"
...
pdf("4M_two_donut_all_75alpha.pdf", width = 11 / 2.54, height = 5 / 2.54, pointsize = 7)
...
pdf("12M_two_donut_all_75.pdf", width = 11 / 2.54, height = 5 / 2.54, pointsize = 7)
par(mfrow = c(1, 2), mar = c(0, 0, 0, 0))
