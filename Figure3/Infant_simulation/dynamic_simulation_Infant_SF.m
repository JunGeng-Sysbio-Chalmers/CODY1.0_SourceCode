function [Tmodel,Y,Ymodel,Ymodel_met,met_udf_co]=dynamic_simulation_Infant_SF(community,n_spc,num_rct,FSG,Feed,flow_back,k,V,ini_stat,time,length_each_tank,km_lumen,Pn_mucosa,km_water,density,Met_Mass,hmo_para,vld,uv)
global lxini spc 
...
[T Y]=my_runge_kutta4_smp_wait(@qssm_comm_Infant_SF,y0,tspan,kmax,n_s,FSG,Feed,V,substrate_index,HMO_index,enzyme_index); 
