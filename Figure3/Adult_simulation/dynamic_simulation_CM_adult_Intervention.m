function [Tmodel,Y,Ymodel,Ymodel_met,met_udf_co]=dynamic_simulation_CM_adult_Intervention(community,n_spc,num_rct,FSG,Feed,flow_back,k,V,ini_stat,time,length_each_tank,km_lumen,Pn_mucosa,km_water,density,Met_Mass,hmo_para,round,vld,uv)
...
%% below is to caculate substrate concentration for each species 
met_co={};
for s=1:n_s
...
[T Y]=my_runge_kutta4(@qssm_comm_adult_CM_Intervention,y0,tspan,kmax,n_s,FSG,Feed,V,substrate_index,HMO_index,enzyme_index);  
